...
module.exports.get_summary = function(coin, exchange, cb) {
...
module.exports.get_trades = function(coin, exchange, cb) {
...
module.exports.get_orders = function(coin, exchange, cb) {
...
module.exports.get_chartdata = function(coin, exchange, cb) { 
  var end = Date.now();
  end = end / 1000;
  start = end - 86400; 
...
module.exports.get_data = function(coin, exchange, cb) {
  var error = null;
